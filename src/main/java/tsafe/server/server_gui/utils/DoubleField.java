...
/**
 * A text field that only accepts valid doubles.
 */
public class DoubleField extends JTextField {
    ...
    //-------------------------------------------
	public DoubleField(int columns, boolean nonNegativeOnly) {
        super(columns);
    ...
    //
 	...
 	protected class DoubleDocument extends PlainDocument {
        ...
        //-------------------------------------------
        private DoubleDocument(DoubleField myField) {
            super();
        ...
        public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
            ...
            for (int i = 0; i < result.length; i++) {
                ...
                else if ((source[i] == '.') && (myField.getText().indexOf('.') == -1)) {
                    result[j++] = source[i];
                }
